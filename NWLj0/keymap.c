...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    CW_TOGG,        KC_B,           KC_L,           KC_D,           KC_W,           KC_Z,                                           KC_QUOTE,       KC_F,           KC_O,           KC_U,           KC_J,           KC_SCLN,        
    MT(MOD_LSFT, KC_BSPC),KC_N,           KC_R,           KC_T,           KC_S,           KC_G,                                           KC_Y,           KC_H,           KC_A,           KC_E,           KC_I,           MT(MOD_RSFT, KC_COMMA),
    KC_LEFT_GUI,    MT(MOD_LALT, KC_Q),KC_X,           KC_M,           KC_C,           KC_V,                                           KC_K,           KC_P,           MT(MOD_RSFT, KC_DOT),KC_DOT,         MT(MOD_RALT, KC_SLASH),KC_RIGHT_CTRL,  
